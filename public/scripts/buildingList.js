/*************************************************************
** File Name: buildingList.js
** Author: Mathew Kagel
** E-mail: kagelm@oregonstate.edu
** Course: CS340-400
** Description: This is the javascript file for the '/buildings'
**   webpage. 
*************************************************************/
...
function bindSelectBy() { // Set selection pulldown values.
  var select = document.getElementById('bld-select-by');
  var reqSess = new XMLHttpRequest();
  var packageSess = {'GetCurrSel': 1};
  reqSess.open('POST', '/buildings', true);
...
function bindSelectValueBy() { // Set selection value pulldown values.
  var select = document.getElementById('bld-select-value-by');
  var reqSess = new XMLHttpRequest();
...
function bindSortBy() { // Set sort value pulldown values.
  var select = document.getElementById('bld-sort-by');
  var reqSess = new XMLHttpRequest();
